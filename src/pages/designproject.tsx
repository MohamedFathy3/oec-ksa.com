...
import Hero from "@/assets/designproject.png";
import section from "@/assets/des.jpg";
    ...
    <div className="min-h-screen">
     ...
     <section className="relative w-full h-screen">
        ...
        <div className="relative z-10 flex items-center justify-center h-full text-center px-4">
          <h1
            className="text-[80px] md:text-[140px] font-bold text-white "
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-gray-600 dark:text-gray-300 leading-relaxed mb-8 text-2xl">
                {t.projects.Description}  {/* استخدام ككائن */}
              </p>
